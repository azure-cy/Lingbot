...
from ._compat import local_shard_size_and_offset
...
def _row_intervals_by_mesh_axis_coordinate(
    ...
    *,
    ...
    for axis_coordinate in range(mesh_axis_size):
        local_num_units, unit_offset = local_shard_size_and_offset(
            num_sharding_units,
            mesh_axis_size,
            axis_coordinate,
        )
...
def _build_batched_matrix_redistribution_plan(
    ...
    *,
    ...
    for mesh_rank, participant in enumerate(participants):
        local_num_matrices, matrix_offset = local_shard_size_and_offset(
            num_matrices,
            len(participants),
            mesh_rank,
        )
